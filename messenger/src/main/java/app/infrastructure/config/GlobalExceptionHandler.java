...
public class GlobalExceptionHandler {
        ...
        /**
         * Maneja excepciones de seguridad (SecurityException).
         * 
         * Se lanza cuando se detectan intentos de:
         * - Path Traversal (acceso a archivos fuera del directorio permitido)
         * - Otros ataques de seguridad detectados a nivel de aplicación
         * 
        ...
        public ResponseEntity<ErrorResponse> handleSecurityException(
                ...
                logger.error("SEGURIDAD: {} en {}", ex.getMessage(), request.getRequestURI());
