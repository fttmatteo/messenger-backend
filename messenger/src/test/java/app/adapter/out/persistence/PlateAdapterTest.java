...
import app.adapter.out.persistence.mapper.PlateMapper;
import app.adapter.out.persistence.repository.PlateRepository;
import app.adapter.out.persistence.adapter.PlateAdapter;
